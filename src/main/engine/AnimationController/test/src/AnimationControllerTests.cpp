...
TEST_F(GivenAnAnimationControllerReady, WhenSecondKeyFrameAddedForObject_ThenBothKeyFramesPresentInStore) {
    ...
    auto keyFrame_2 = AnimationController::createKeyFrame(UPDATE_POSITION, expTimeSecond);
    ...
    ASSERT_EQ(UPDATE_POSITION, kfStore.at(DUMMY_OBJ_NAME).kQueue.back().get()->type);
}
...
TEST_F(GivenAnAnimationControllerReady, WhenKeyFrameCompletes_ThenFinalVectorTransformationOccurs) {
    ...
    auto keyFrame_1 = AnimationController::createKeyFrame(UPDATE_POSITION, targetTime);
...
TEST_F(GivenAnAnimationControllerReady, WhenKeyFramesAddedForMultipleObjects_ThenBothObjectsUpdateSimultaneously) {
    ...
    auto keyFrame_1 = AnimationController::createKeyFrame(UPDATE_POSITION, targetTime);
    auto keyFrame_2 = AnimationController::createKeyFrame(UPDATE_POSITION, targetTime);
...
TEST_F(GivenAnAnimationControllerReady, WhenKeyFrameCompletesForOneObject_ThenOtherObjectRemainsInStore) {
    ...
    auto keyFrame_1 = AnimationController::createKeyFrame(UPDATE_POSITION, targetTime_1);
    auto keyFrame_2 = AnimationController::createKeyFrame(UPDATE_POSITION, targetTime_2);
...
TEST_F(GivenAnAnimationControllerReady, WhenCallbackAddsKeyFrame_ThenNoDeadLockOccurs) {
    ...
    ASSERT_EQ(UPDATE_POSITION, animationController_.getKeyFrameStore().at(DUMMY_OBJ_NAME).kQueue.front().get()->type);
...
TEST_F(GivenAnAnimationControllerReady, WhenDeltaTransformConfigured_ThenUpdatedAsExpected) {
    ...
    deltaTime = 1.0f;
    auto keyFrame_1 = AnimationController::createKeyFrame(UPDATE_DELTA, totalTime);
